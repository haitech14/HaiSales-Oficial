...
import { formatServiciosHeaderDate } from "@/lib/servicios/servicios-page-utils";
import { MODULE_PAGE_BG } from "@/lib/module-page-theme";

type ServiciosPageHeaderProps = {
  selectedDate: Date;
  onPreviousDay: () => void;
  onNextDay: () => void;
  onOpenCalendar?: () => void;
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-[2rem] font-bold leading-none tracking-tight text-slate-900">Servicios</h1>
          <p className="mt-2 text-[15px] font-medium text-slate-500">
            {formatServiciosHeaderDate(selectedDate)}
          </p>
        </div>
