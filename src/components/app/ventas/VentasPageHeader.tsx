...
export function VentasPageHeader({
  selectedDate,
  onPreviousDay,
  onNextDay,
  onOpenCalendar,
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          <h1 className="text-[2rem] font-bold leading-none tracking-tight text-slate-900">Ventas</h1>
