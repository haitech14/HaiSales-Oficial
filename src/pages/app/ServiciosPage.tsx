...
import { ServiciosRightPanel } from "@/components/app/ServiciosRightPanel";
...
import {
  ...
  serviciosTabs,
} from "@/lib/servicios/servicios-service";
...
export default function ServiciosPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <AppPageHeader
        title="Servicios"
        subtitle="Controla órdenes de servicio, tickets, visitas técnicas, cotizaciones y facturación."
        showPanelToggle
              ...
              <div className="flex flex-wrap items-center gap-2 border-b border-slate-100 px-4 py-3">
                <div className="relative min-w-[220px] flex-1">
                  ...
                  <input
                    ...
                    placeholder="Buscar por cliente, técnico, equipo o OS..."
                ...
                <table className="app-table-body w-full min-w-[720px] text-left sm:min-w-[1200px]">
                  <thead>
                    <tr className="app-table-head-row">
                      ...
                      <th className="app-table-cell">OS</th>
                      <th className="app-table-cell">Cliente</th>
                      <th className="app-table-cell">Tipo de servicio</th>
                      <th className="app-table-cell">Técnico</th>
                      ...
                      paginatedRecords.map((item) => (
                        ...
                        >
                          ...
                          <td className="app-table-cell">
                            <span
                              className={cn(
                                ...
                                getServicioTipoStyles(item.serviceType),
                              )}
                            >
                              {item.serviceType}
                            </span>
                          </td>
                          <td className="app-table-cell text-slate-700">{item.technician}</td>
                          <td className="app-table-cell text-slate-700">{item.equipment}</td>
                          <td className="app-table-cell">
                            <span
                              className={cn(
                                "app-table-badge inline-flex rounded-full border",
                                getServicioEstadoStyles(item.status),
                              )}
                            >
                              {item.status}
                            </span>
                          ...
                          <td className="app-table-cell text-right font-semibold text-slate-900">
                            {formatServicioCurrency(item.amount)}
                          </td>
              ...
              <div className="app-pagination-bar flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 px-4 py-2.5">
                <p>
                  {filteredCount === 0
                    ...
                    : `Mostrando ${startIndex.toLocaleString("es-PE")} a ${endIndex.toLocaleString("es-PE")} de ${filteredCount.toLocaleString("es-PE")} servicios`}
                </p>
