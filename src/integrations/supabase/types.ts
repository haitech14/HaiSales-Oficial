...
export type Database = {
  public: {
    Tables: {
      ...
      trabajadores: {
        Row: {
          ...
          hora_refrigerio: string | null;
          en_planilla: boolean;
          sistema_pensiones: "afp" | "onp" | null;
          seguro_salud: "essalud" | "sis" | null;
    ...
    Functions: {
      ...
      clear_demo_data_for_user: {
        Args: { p_user_id: string };
        Returns: undefined;
      };
      import_clientes_legacy_for_user: {
        Args: { p_user_id: string };
        Returns: number;
      };
      import_ventas_legacy_for_user: {
        Args: { p_user_id: string };
        Returns: number;
      };
      ...
      import_guias_legacy_for_user: {
        Args: { p_user_id: string };
        Returns: number;
      };
      import_productos_legacy_for_user: {
        Args: { p_user_id: string };
        Returns: number;
      };
      sync_prospeccion_sin_compra_for_user: {
        Args: { p_user_id: string };
        Returns: number;
      };
    };
